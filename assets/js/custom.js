! function(e) {
    ...
    var i = e(window),
        a = e(document);
    e(function() {
            e(".navigation-menu > ul > li:has( > ul)").addClass("menu-dropdown-icon"), e(".navigation-menu > ul > li.menu-dropdown-icon").append('<div class="dropworn-arrow"></div>'), e(".navigation-menu > ul > li > ul:not(:has(ul))").addClass("normal-sub"), e(".navigation-menu > ul").before('<a href="#" class="menu-mobile"><i class="fa fa-bars"></i></a>');
