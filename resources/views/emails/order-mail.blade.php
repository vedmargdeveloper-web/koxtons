...
<body>
	...
	<div class="container">
		...
		<p>Hi {{ $order->order_customer[0]->first_name }},</p>

		<div class="thankyou">
			<h3>Thank you for your order {{ $order->order_id }}</h3>
		</div>
		    ...
		    @if( $cart )
				...
				<table class="table">
					...
					<tfoot>
						...
						@endif
						<tr>
							<th colspan="5"class="red-color"><strong class="red-color">Shipping charge</strong></th>
