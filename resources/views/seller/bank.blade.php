        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ Form::open(['url' => route('seller.bank')]) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group">
                                    <div class="form-field-wrapper {{ $errors->has('gst') ? ' has-error' : '' }}">
                                        ...
                                        <input id="gst" placeholder="43238498489" class="form-control input-md form-full-width" name="gst" placeholder="Enter GST nol." value="{{ $gst }}" aria-required="true">
                                        @if ($errors->has('gst'))
