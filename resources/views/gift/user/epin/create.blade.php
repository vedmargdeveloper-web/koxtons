...
@section('content')
    ...
    <div class="row justify-content-center login-card">
        ...
        <div class="col-md-8">
            ...
            <form method="POST" class="epin-creation-form" enctype="multipart/form-data" action="{{ route('epin.store') }}">
                {{ csrf_field() }}
                        ...
                        <div class="section-panel mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 form-group">
                                    ...
                                    <input type="text" class="form-control{{ $errors->has('reference') ? ' is-invalid' : '' }}" placeholder="Reference ID" name="reference" value="{{ Auth::user()->username }}" readonly required>
                        ...
                        <div class="section-panel mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-xs-4 form-group">
                                    ...
                                    <select name="payment_mode" class="form-control payment-mode" autofocus>
                                        ...
                                        <option {{ old('payment_mode') == 'wallet' ? 'selected' : '' }} value="wallet">Wallet</option>
