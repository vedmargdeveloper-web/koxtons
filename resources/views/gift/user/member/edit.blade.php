...
@section('content')
    ...
    <div class="row justify-content-center login-card">
        ...
        <div class="col-md-8">
            ...
            <a title="Go Back" class="btn-back" href="{{ route('member.network') }}"><span class="fas fa-angle-left"></span></a>
            <a title="Add Member" class="btn-back" href="{{ route('member.create', 'create') }}"><span class="fas fa-user-plus"></span></a>
            <a title="View Member" class="btn-back" href="{{ route('member.view', $user->id) }}"><span class="fas fa-eye"></span></a>
                        ...
                        <div class="section-panel mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12 form-group">
                                    ...
                                    <input id="reference" type="text" class="form-control{{ $errors->has('reference') ? ' is-invalid' : '' }}" placeholder="Reference ID" name="reference" value="{{ $user->ref_id }}" required readonly>
