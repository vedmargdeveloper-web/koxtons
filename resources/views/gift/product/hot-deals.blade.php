...
@section('content')
    ...
    <div class="page-content-wraper">
        ...
        <section class="content-page products-page">
            ...
            <div class="container product-container category" data-id="{{ $parent }}">
                                        ...
                                        <div class="product-list-wrapper product-item">
                                            ...
                                            <div class="product-detail">
                                                <div class="product-title">
                                                    <a
                                                        href="{{ route('product.view', [$row->product_category[0]->slug, $row->slug, $row->product_id]) }}">{{ get_excerpt($row->title, 6) }}</a>
                                                </div>
                                                <h5 class="item-price">
                                                    <?php $price = $row->price; ?>
                                                    @if ($row->discount)
