                        ...
                        @if( $user )
                            ...
                            <div class="card">
                                ...
                                <div class="card-block" style="padding: 30px;">
                                    ...
                                    @endif
                                      <form action="{{route('customer.profile.update')}}" method="post" accept-charset="utf-8">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mobile" value="{{$user->mobile}}" class="form-control" placeholder="Enter Mobile">
                                                </div>
                                            </div>
