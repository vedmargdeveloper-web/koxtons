...
<?php $size0 = config('filesize.medium.0'); $size1 = config('filesize.medium.1'); ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-10.jpeg') }}" alt="Promo Banner" >
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-8.jpeg') }}" alt="Promo Banner">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <h1 class="page-title">{{ ucwords($category->name) }} 
                            <a href="{{ route('category.product', ['mens', $category->slug]) }}" class="btn-more pull-right">View More</a>
                        </h1>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div id="new-product" class="product-item-5 owl-carousel owl-theme nf-carousel-theme1">
                            ...
                            <div class="product-item">
                                ...
                                <a href="{{ route('product.view', [$category->slug, $row->slug, $row->product_id]) }}">
                                    <div class="product-item-inner">
                                        <div class="product-img-wrap">
                                            <img src="{{ asset( 'public/'. product_file( thumb( $row->feature_image, $size0, $size1 ) ) ) }}" alt="{{ $row->title ?? 'Product Image' }}">
                                            @if( $row->discount )
                                        ...
                                        <div class="product-over">
                                            @if( $row->available > 0 )
                                                <div class="product-button">
                                                    <div role="button" class="btn-cart" id="addToCartProduct" data-value="{{ $row->product_id }}" data-id="{{ $row->id }}" data-mode="top" data-tip="Add To Cart"><i class="fa fa-shopping-bag"></i></div>
        ...
        <section class="section-padding promo-banner">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-13.jpg') }}" alt="Promo Banner">
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-16.jpg') }}" alt="Promo Banner">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="section-padding promo-banner">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-17.jpg') }}" alt="Promo Banner">
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-18.jpg') }}" alt="Promo Banner">
                        </a>
                    </div>
                </div>
            </div>
