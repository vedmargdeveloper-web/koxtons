                ...
                @forelse($productMrps as $mrp)
                    <tr>
                        ...
                        {{-- <td>{{ $mrp->model }}</td> --}}
                         <td>
                            {{ $mrp->model }}
                            <ul class="action d-inline-flex align-items-center gap-2 ms-2" style="list-style:none; margin-left:20px;">
                                <li>
                                    <a href="{{ route('product-mrps.edit', $mrp->id) }}">Edit</a>
                                </li>
                                <li><span class="pipe"></span></li>
                                <li>
                                    <a href="{{ route('receipt.print', $mrp->id) }}" target="_blank" style="color: rgb(15, 15, 93)">
                                        Print
                                    </a>
                                </li>
                                <li><span class="pipe"></span></li>
                                <li class="mt-3">
                                    {!! Form::open(['method' => 'DELETE', 'route' => ['product-mrps.destroy', $mrp->id], 'style' => 'display:inline']) !!}
                                        {!! Form::submit('Delete', [
                        ...
                        {{-- <td>
                            ...
                            <a href="{{ route('receipt.print', $mrp->id) }}" target="_blank" class="primary"
                                style="color: rgb(15, 15, 93)">
                                Print
                            </a>
                            ...
                            <form id="delete-form-{{ $mrp->id }}"
                                action="{{ route('product-mrps.destroy', $mrp->id) }}" method="POST"
                                style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
