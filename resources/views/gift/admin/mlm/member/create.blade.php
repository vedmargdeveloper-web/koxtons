...
@section('content')
        ...
        <div class="justify-content-center login-card">
            ...
            <div class="col-md-5">
                ...
                <form method="POST" id="member-creation-form" action="{{ route('mlm.member.store') }}">
                {{ csrf_field() }}

                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">{{ __('Add Member') }}</div>
                        </div>
        ...
        @if( $uid && $user && $step === 'contact' )
            ...
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('mlm.member.store') }}">
                {{ csrf_field() }}

                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">{{ __('Contact & Bank Details') }}</div>
                        </div>
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        {{ Form::open(['url' => route('mlm.member.create', 'create'), 'method' => 'GET']) }}
                            <input type="hidden" name="uid" value="{{ $uid }}">
                    ...
                    <form method="POST" action="{{ route('mlm.member.store') }}" data-id="{{ $uid }}" id="document-form">
                        {{ csrf_field() }}
