        ...
        <div class="card-body pt-5 pb-5">
                ...
                @if( $user )
                    ...
                    @if( $step === 'document' && isset($user->userdetail[0]->mobile) && $user->userdetail[0]->mobile )
                        ...
                        <form method="POST" action="{{ route('admin.seller.document') }}" data-id="{{ $user->uid }}" id="document-form">
                            {{ csrf_field() }}
                            ...
                            <div class="">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-4">
                                        @if( $avtar )
                                            <img id="avtar" style="width: 150px;" class="img-thumbnail" src="{{ asset('public/images/avtars/'.thumb( $avtar, 120, 120)) }}">
                                        @else
                    ...
                    @else
                        ...
                        <a href="{{ route('admin.seller.edit', $user->id) }}">Go Back</a>

                        <form method="POST" action="{{ route('admin.seller.setup.store') }}">
                            {{ csrf_field() }}
                            
                            <h1 class="normal text-center"><span>Setup Profile</span></h1>
                            ...
                            <div class="form-section mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                            ...
                                            <input id="phone" class="form-control form-full-width" name="phone" placeholder="+917500996633" value="{{ $phone }}" aria-required="true">
                                            @if ($errors->has('phone'))
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                            ...
                                            <input id="alternate" class="form-control form-full-width" name="alternate" placeholder="+917500996633" value="{{ $alternate }}" aria-required="true">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-xs-4 form-group">
                                        ...
                                        <select name="country" class="form-control form-full-width" id="countries">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-4 form-group">
                                        ...
                                        ?>
                                        <select name="state" class="form-control form-full-width" id="states">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-4 form-group">
                                        ...
                                        ?>
                                        <select name="city" class="form-control form-full-width" id="cities">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 form-group">
                                        ...
                                        ?>
                                        <label>Address</label>
                                        <input type="text" placeholder="D-119, Metro Plaza" value="{{ $address }}" name="address" class="form-control form-full-width">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-xs-12 form-group">
                                        ...
                                        <input type="text" name="landmark" placeholder="HRS Chowk" value="{{ $landmark }}" class="form-control form-full-width">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-xs-12 form-group">
                                        ...
                                        ?>
                                        <label>Pincode</label>
                                        <input type="text" name="pincode" placeholder="250002" value="{{ $pincode }}" class="form-control form-full-width">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group {{ $errors->has('gst') ? ' has-error' : '' }}">
                                            ...
                                            <input id="gst" placeholder="43238498489" class="form-control form-full-width" name="gst" placeholder="Enter GST nol." value="{{ $gst }}" aria-required="true">
                                            @if ($errors->has('gst'))
                                                <span class="alert-warning">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                         <div class="form-group {{ $errors->has('account_holder_name') ? ' has-error' : '' }}">
                                            ...
                                            <input id="account_holder_name" class="form-control form-full-width" name="account_holder_name" placeholder="Account holder name" value="{{ $account_holder_name }}" aria-required="true">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                         <div class="form-group {{ $errors->has('bank_name') ? ' has-error' : '' }}">
                                            ...
                                            <input id="bank_name" class="form-control form-full-width" name="bank_name" placeholder="Bank name" value="{{ $bank_name }}" aria-required="true">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                         <div class="form-group {{ $errors->has('account_no') ? ' has-error' : '' }}">
                                            ...
                                            <input id="account_no" class="form-control form-full-width" name="account_no" placeholder="Account no" value="{{ $account_no }}" aria-required="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                         <div class="form-group {{ $errors->has('bank_ifsc') ? ' has-error' : '' }}">
                                            ...
                                            <input id="bank_ifsc" class="form-control form-full-width" name="bank_ifsc" placeholder="IFSC code" value="{{ $bank_ifsc }}" aria-required="true">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                         <div class="form-group {{ $errors->has('bank_address') ? ' has-error' : '' }}">
                                            ...
                                            <input id="bank_address" class="form-control form-full-width" name="bank_address" placeholder="Bank address" value="{{ $bank_address }}" aria-required="true">
