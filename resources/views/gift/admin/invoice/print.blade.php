...
<body>
			...
			<tbody style="width: 100%;">
				<tr style="width:100%;">
					<td style="width:50%">
						...
						<img style="width:140px;" src="{{ asset('public/assets/images/'.$logo) }}" alt="{{ $site_name }}">
					</td>
	...
	<div class="container" style="margin-top:0px;" style="display: none;">
				...
				<tr style="width:100%;">
					...
					<td style="width:50%;text-align:right;">
						...
						@if( $order->order_customer && count( $order->order_customer ) > 0 )
							<p style="margin:0">{{ ucwords($order->order_customer[0]->first_name.' '.$order->order_customer[0]->last_name) }}<br>
							{{ ucfirst( implode(', ', json_decode($order->order_customer[0]->address)) ) }}, 
							{{ $order->order_customer[0]->city }}, {{ $order->order_customer[0]->state }}, {{ $order->order_customer[0]->country }}, {{ $order->order_customer[0]->pincode }}</p>
						@endif
