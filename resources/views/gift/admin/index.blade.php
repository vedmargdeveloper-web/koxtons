...
<body>
	...
	<section class="mt-5">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-md-3 col-md-12 col-sm-12-col-xs-12 pt-5">
					<div class="form-container bg-shadow mt-5">
						<h3 class="mb-5">Login</h3>

						@if( Session::has('admin_log_err') )
							<span class="warning"><i class="fa fa-warning"></i> {{ Session::get('admin_log_err') }}</span>
						@endif
