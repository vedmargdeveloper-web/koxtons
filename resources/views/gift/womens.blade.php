            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-10.jpeg') }}"    alt="Promotional Banner 10"  >
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-8.jpeg') }}"    alt="Promotional Banner 8" >
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="section-padding promo-banner">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-13.jpg') }}"  alt="Promotional Banner" >
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-16.jpg') }}" alt="Promotional Banner"  >
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="section-padding promo-banner">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-17.jpg') }}"    alt="Promotional Banner " >
                        </a>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <a href="">
                            <img src="{{ asset('public/assets/images/banner-sm-18.jpg') }}"    alt="Promotional Banner " >
                        </a>
                    </div>
                </div>
            </div>
