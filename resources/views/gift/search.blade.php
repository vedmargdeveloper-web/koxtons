                            ...
                            <div class="product-filter-wrapper">
                                ...
                                <div class="product-filter-row">
                                    ...
                                    <div class="filter-content-categories filter-content">
                                        ...
                                        <?php $categories = App\model\Category::whereNotIn('id', $notids)->orderBy('name', 'asc')->get();
                                        $c = 0; ?>
                                                ...
                                                <div class="product-list-wrapper product-item">
                                                    <div class="product-image-wrapper">
                                                        <a
                                                            ...
                                                            <img src="{{ asset('public/' . product_file(thumb($row->feature_image, config('filesize.thumbnail.0'), config('filesize.thumbnail.1')))) }}"
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="list-page-title row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                <h1 class="">{{ $category ? ucwords($category->name) : '' }} <small>
                                        ({{ $products ? $products->total() : 0 }} Products)</small></h1>
                            </div>
                        </div>
                                                    ...
                                                    <div class="image">
                                                        <a
                                                            ...
                                                            <img src="{{ asset('public/' . product_file(thumb($row->feature_image, config('filesize.medium.0'), config('filesize.medium.1')))) }}"
                                                              alt="{{ $row->feature_image_alt ?? '' }}"  title=""
