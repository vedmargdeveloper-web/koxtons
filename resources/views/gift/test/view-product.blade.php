    ...
    <section id="product-{{ $product->product_id }}" class="content-page single-product-content">
        ...
        <div id="product-detail" class="container">
            <div class="row">
                ...
                @if( $agent->isDesktop() )
                <!-- Product Image -->
                <div class="col-lg-z col-md-6 col-sm-12 mb-30">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                    <div class="product-page-content">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 product-filters">
                            <form>
                                <div class="row filters-color mb-3">
                                ...
                                <div class="row filters-size">
                                    @if( $product->productMeta[0]->size )
                                    
                                        <label for="select-color">Select Size</label>
                                        
                                        <?php $size = explode(',', $product->productMeta[0]->size); ?>
                                        <div class="color-selector size-selector">
                                            @foreach( $size as $key => $s )
                                                
                                                <div data-value="{{ $s }}" class="size entry {{ $key < 1 ? 'active' : '' }}" title="{{ ucwords($s) }}" style="">&nbsp;</div>
                                                <span class="mr-2">{{ strtoupper($s) }}</span>
                                            @endforeach
                                        </div>
                                    @endif
                                ...
                                <div class="single-variation-wrap">
                                    ...
                                    <button type="button" id="addToCartProductTest" data-value="{{ $product->product_id }}" data-id="{{ $product->id }}" class="btn btn-lg btn-black"><i class="fa fa-shopping-bag" aria-hidden="true"></i>Add to cart</button>
                                </div>
                            </form>
                        </div>
