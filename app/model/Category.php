...
{
    protected $fillable = ['name', 'slug', 'parent', 'description', 'feature_image','feature_image_alt','order_by','product_priority_desktop','product_priority_mobile', 'status','metatitle','metadescription','metakey','postmeta'];
